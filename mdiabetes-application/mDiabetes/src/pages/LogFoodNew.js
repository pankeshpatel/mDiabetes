    ...
    <SafeAreaView style={styles.root}>
      <ScrollView
        ...
        <Text style={styles.heading}>
          Enter the food items name, quantity with units
        </Text>
        <Text></Text>
          ...
          return (
            <View style={styles.flexDisplay}>
              <View
                ...
                <TextInput
                  style={{borderWidth: 1, height: 40, flex: 0.91, width: 130}}
                  onChangeText={value => {
                    handleUpdate('name', value, index);
                  }}></TextInput>
              </View>
              <View style={{backgroundColor: 'lightgrey', color: 'black'}}>
                <TextInput
                  style={{borderWidth: 1, height: 40, flex: 0.91, width: 60}}
                  onChangeText={value => {
                    handleUpdate('quantity', value, index);
                  }}></TextInput>
              </View>
              <View>
                <SelectDropdown
                  ...
                  onSelect={(selectedItem, i) => {
                    handleUpdate('units', selectedItem, index);
                  }}
        ...
        <Button
          onPress={handleAdd}
          mode="contained"
          style={{width: 150, marginLeft: 180}}>
          {' '}
          Add new{' '}
        </Button>
        <Text></Text>
        ...
        <Button onPress={handleSumbit} mode="contained">
          {' '}
          SUBMIT{' '}
        </Button>
      </ScrollView>
