...
import { TextInput, Button, Text, RadioButton, Title, Subheading, IconButton,Modal,Portal } from "react-native-paper"
import { SafeAreaView } from 'react-native-safe-area-context';
import AsyncStorage from '@react-native-async-storage/async-storage';

export default function LogFoodIntro2({ route, navigation }) {
	...
	const handleNext = async () => {
		...
		navigation.navigate("LogFoodNew", { type: values["type"] })
	}
	...
	return (
		<>
			<ScrollView style={styles.root}>
				<Subheading style={styles.subheading}>Please Select Type of Meal</Subheading>
				...
				<Text></Text>
				<Text></Text>
				<Button mode="contained" onPress={handleNext} disabled={submitDisabled}>
					Next
				</Button>
